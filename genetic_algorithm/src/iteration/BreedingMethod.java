...
/**
 * An abstract class for a breeding method. The default behavior is mutate all, or in other words, each specimen is mutate and there is a random 
 * number of crossovers (uniformly distributed from 0 to n, where n is the number of specimens).
 * @author John
 *
 */
public abstract class BreedingMethod {
     ...
     * @param oldSpecimens
     */
    public BreedingMethod(List <Specimen> oldSpecimens){
     ...
     * @param oldSpecimens
     */
    public BreedingMethod(List <Specimen> oldSpecimens, double mutationRate){
        this.oldSpecimens = oldSpecimens;
